           ...
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
                ...
                <li class="text-center">
                    ...
                    <li>
                        <a  align="center"   href="index2.html"><strong> Profile</strong></a>
                    </li>
     <li>
                        <a align="center" class="active-menu" href="ui1.html"><strong>Registration</strong></a>
                    </li>
            ...
            <div id="page-inner">
                <div class="row">
                 ...
                 <div class="row">
                    ...
                    <a href="../login1/patientsignup.php" class="btn btn-primary btn-lg">SIGNUP</a>
                      ...
                      <div class="panel panel-default">
                        <div class="panel-heading">
                           CHILD REGISTRATION
                                    ...
                                    <a href="../login1/childsignup.php" class="btn btn-primary btn-lg">SIGNUP</a>
